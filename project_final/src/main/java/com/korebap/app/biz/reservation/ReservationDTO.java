...
public class ReservationDTO {
	...
	public String toString() {
		return "ReservationDTO [reservation_num=" + reservation_num + ", reservation_payment_num="
				...
				+ ", reservation_condition=" + reservation_condition + ", getReservation_product_file_dir()="
				+ getReservation_product_file_dir() + ", getReservation_condition()=" + getReservation_condition()
				+ ", getReservation_payment_method()=" + getReservation_payment_method()
				+ ", getReservation_payment_status()=" + getReservation_payment_status()
				+ ", getReservation_product_name()=" + getReservation_product_name() + ", getReservation_price()="
				+ getReservation_price() + ", getReservation_payment_date()=" + getReservation_payment_date()
				+ ", getReservation_member_name()=" + getReservation_member_name() + ", getReservation_member_phone()="
				+ getReservation_member_phone() + ", getReservation_num()=" + getReservation_num()
				+ ", getReservation_member_id()=" + getReservation_member_id() + ", getReservation_payment_num()="
				+ getReservation_payment_num() + ", getReservation_registration_date()="
				+ getReservation_registration_date() + ", getReservation_status()=" + getReservation_status()
				+ ", getReservation_product_num()=" + getReservation_product_num() + ", getClass()=" + getClass()
