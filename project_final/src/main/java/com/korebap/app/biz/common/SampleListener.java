...
//
//	@Autowired
//	private FileService fileService; // 파일 서비스
//
//	@Autowired
...
//		productDTO.setProduct_condition("PRODUCT_SELECT"); //컨디션
//
//		// 상품 데이터가 없을 경우 크롤링 수행
//		if (productService.selectOne(productDTO) == null) {
...
//			insertProducts(CrawlingSelenium.makeSampleProductSeaBoat(), "PRODUCT_CRAWLING_SEA_BOAR_INSERT");
//
//			System.out.println("SampleListener.processProducts 로그: 바다 낚시터 데이터 삽입 시작");
//			insertProducts(CrawlingSelenium.makeSampleProductSeaFishing(), "PRODUCT_CRAWLING_SEA_FISHING_INSERT");
//
//			System.out.println("SampleListener.processProducts 로그: 민물 낚시터 데이터 삽입 시작");
//			insertProducts(CrawlingSelenium.makeSampleProductFreshWaterFishing(), "PRODUCT_CRAWLING_FRESH_WATER_FISHING_INSERT");
//
//			System.out.println("SampleListener.processProducts 로그: 민물 낚시터 카페 데이터 삽입 시작");
//			insertProducts(CrawlingSelenium.makeSampleProductFreshWaterFishingFishingCafe(), "PRODUCT_CRAWLING_FRESH_WATER_FISHING_CAFE_INSERT");
//
//		} else {
...
//
//	// 상품 삽입 메서드
//	private void insertProducts(ArrayList<ProductDTO> products, String condition) {
...
//						imageFileDTO.setFile_condition("FILE_PRODUCT_CRAWLING_INSERT");
...
//
//		if (boardService.selectOne(boardDTO) == null) { // 게시판 데이터가 없을 경우
