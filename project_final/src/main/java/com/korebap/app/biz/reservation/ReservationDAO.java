...
public class ReservationDAO {
	...
	// 예약 생성
	private final String INSERT = "INSERT INTO RESERVATION (RESERVATION_PAYMENT_NUM, RESERVATION_REGISTRATION_DATE) VALUES (?, ?)";

	// 예약 내용 변경 (예약 상태 변경)
	private final String UPDATE = "UPDATE RESERVATION SET RESERVATION_STATUS = ? WHERE RESERVATION_NUM = ?";

	// 내 예약 전체보기
	private final String SELECTALL = "SELECT R.RESERVATION_NUM, R.RESERVATION_REGISTRATION_DATE, R.RESERVATION_STATUS, "
	...
	// 내 예약 상세보기
	private final String SELECTONE = "SELECT P.PAYMENT_NUM, R.RESERVATION_NUM, R.RESERVATION_REGISTRATION_DATE, R.RESERVATION_STATUS, "
