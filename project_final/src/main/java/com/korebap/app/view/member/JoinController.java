...
public class JoinController {
	...
	public String join(MemberDTO memberDTO, Model model) {
		System.out.println("JoinController.java join() 시작");
		...
		System.out.println("JoinController.java join() 끝");
		return "info";
	}
	/////////////// 회원가입 메서드 끝
	...
	public String checkMemberId(MemberDTO memberDTO) {
		System.out.println("JoinController.java checkMemberId() 시작");
	...
	public void sendMail(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("JoinController.java sendMail() 시작");
        ...
        System.out.println("JoinController.java sendMail() 끝");
	}
	/////////////// 이메일 인증 메서드 끝
}
