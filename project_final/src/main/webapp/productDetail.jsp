                        ...
                        <div class="single-comment-item">
                           ...
                           <div class="sc-text">
                              ...
                              <c:if test="${member_id == review.review_writer_id}">
                               <a href="javascript:void(0);" class="deleteReview comment-btn" 
                               data-review-num="${review.review_num}" data-product-num="${product.product_num}">리뷰삭제</a>
                              </c:if>
                           </div>
                        </div>
                     </c:forEach>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.deleteReview', function() {
        ...
        var flag = confirm("정말로 이 리뷰를 삭제하시겠습니까?");
        if (flag) {
            // 확인을 클릭한 경우, 삭제 요청을 서버로 전송
            window.location.href = "deleteReview.do?review_num=" + reviewNum + "&product_num=" + productNum;
        }
    });
});
</script>
