...
<head>
	...
	<script type="module" src="js/board/CKEditor.js"></script>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-text">
                        <div class="leave-comment ">
                            <!-- 글 작성 폼 -->
                            <h2 class="d-flex justify-content-center mb-5">글 작성</h2>
                             <form action="BOARDINSERTACTION.do" method="POST" name="editing" enctype="multipart/form-data">
				                <div class="row">
				                    <div class="col-md-12">
