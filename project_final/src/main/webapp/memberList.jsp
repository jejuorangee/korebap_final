...
<div class="container mb-5">
	<div id="page-wrapper" >
		<div class="header"> 
			<h1 class="page-header">일반 사용자 목록</h1>
	   	</div>
				            		...
				            		<table class="table table-striped table-bordered table-hover" id="dataTables-example">
				                		...
				                		<!-- 실 데이터 반복 -->
					                		<c:if test="${empty memberList}">
					                			<tr><td colspan=5>일반 사용자가 없습니다.</td></tr>
					                		</c:if>
					                		<c:forEach var="member" items="${memberList}">
						                		<a href="mypage.do?member_id=${member.member_id}">
							                		<tr>
								                        ...
								                        <td>
								                        	<div class="d-flex justify-content-between">
								                        		<a href="MemberBan.do?member_id=${member.member_id}" class="btn btn-primary disabled" role="button" aria-disabled="true">정지</a>
								                        		<a href="deleteMember.do?member_id=${member.member_id}" class="btn btn-primary disabled" role="button" aria-disabled="true">탈퇴</a>
							                        		</div>
					                        			</td>
					                        		</tr>
				                        		</a>
